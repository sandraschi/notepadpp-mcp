...
class LinkParser:
    ...
    def _parse_images(self, content: str, result: LinkParseResult, start_time: float):
    ...
    def _parse_raw_urls(self, content: str, result: LinkParseResult, start_time: float):
