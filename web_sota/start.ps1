...
# Web SOTA start Ã¢â‚¬â€ frontend 10814, FastAPI bridge 10815 (see mcp-central-docs WEBAPP_PORTS)
$WebPort = 10814
$BackendPort = 10815
...
# Run from repo root with -WorkingDirectory so `uv run` resolves notepadpp_mcp Ã¢â‚¬â€ no PYTHONPATH (avoids quoting bugs in -Command).
