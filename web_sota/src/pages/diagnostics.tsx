    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          Bundled <code className="text-slate-300">status_ops</code> calls:{" "}
          <code className="text-slate-300">health_check</code> and{" "}
          <code className="text-slate-300">system_status</code> via{" "}
          <code className="text-slate-300">GET /api/diagnostics</code>.
        </p>
      </div>
      ...
      <Card className="border-slate-800 bg-slate-950/50">
        ...
        <CardContent>
          ...
          {q.isError && (
            <p className="text-red-400 text-sm">{(q.error as Error).message}</p>
          )}
          {q.data && (
