    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          Pulled from the Python bridge:{" "}
          <code className="text-slate-300">/api/docs/overview</code>,{" "}
          <code className="text-slate-300">/api/mcp/meta</code>,{" "}
          <code className="text-slate-300">/api/http/routes</code>.
        </p>
      </div>
      ...
      <Card className="border-slate-800 bg-slate-950/50">
        ...
        <CardContent>
          {meta.isLoading && (
            <p className="text-slate-400 text-sm">Loading meta…</p>
          )}
          {meta.isError && (
              ...
              <table className="w-full text-sm text-left">
                ...
                <tbody>
                  {restTable.map((row) => (
                    ...
                    >
                      <td className="py-2 pr-2 font-mono text-amber-400/90">
                        {row.method}
                      </td>
                  ...
                  <table className="w-full text-sm">
                    <tbody>
                      {routes.data.routes.map((r) => (
                        ...
                        >
                          <td className="py-1 pr-3 font-mono text-amber-400/90">
                            {r.method}
                          </td>
