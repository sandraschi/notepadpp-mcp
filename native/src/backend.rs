...
const BACKEND_NAME: &str = "notepadpp-mcp-backend.exe";
const BACKEND_PORT: u16 = 10815;
const BACKEND_TAG: &str = "notepadpp-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "NOTEPADPP_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 10815",
