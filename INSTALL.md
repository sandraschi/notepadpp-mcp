...
4. Start the server:
   ...
   uv run python -m notepadpp_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn notepadpp_mcp.server:app --port 10815
   ```
5. Open `http://localhost:10815` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/notepadpp-mcp/issues) |
